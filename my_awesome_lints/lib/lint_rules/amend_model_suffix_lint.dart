...
class _AmendModelSuffixFix extends DartFix {
  ...
  void run(
    ...
    context.registry.addClassDeclaration((node) {
      ...
      final validName = node.name.lexeme + AmendModelSuffix._modelSuffix;
      // node.name.lexeme.substring(          0, node.name.lexeme.length - AmendModelSuffix._modelSuffix.length);
